...
BOOT_QUOTES = [
    "Every binary tells a story. Some just whisper it in XOR and Base64. sounds lame but true.",
    "Entropy doesn't lie. Difficulty scores sometimes do ( working on that ).",
...
def welcome_screen():
    ...
    print(f"{DIM_GREEN}v2.0 -- SysTorch{RESET}")
...
def display_laughing_skull_outro():
    ...
    print()
    typewriter("  Whatever you found in there, it'll still be there next time, Probably.", delay=0.02, color=DIM_GREEN)
    typewriter("  Thanks for using SysTorch.",
...
def goodbye():
    ...
    print()
    typewriter("Stay curious.", delay=0.02, color=BOLD_GREEN)
    print()
